...
def loss_fn(model, params, diff_params, x, t, noise, prng):
    """
    ...
    model_output = model.apply(params, x_diffused, t, train = True, rngs={'dropout': prng})
...
def loss_fn_mean(model, params, diff_params, x, t, noise, prng):
    """
    Whole batch mean calculating wrapper for loss_fn
    """
    return jnp.mean(loss_fn(model, params, diff_params, x, t, noise, prng))
